(function (global, factory) {
  ...
  (global = global || self, global.WFS_WMS = factory(global.L));
  ...
  var parse = function parse(xml) {
    var _xml$children = _slicedToArray(xml.children, 1),
        root = _xml$children[0];
    ...
    function drawFeatures(data) {
      if (data.name === "wfs:FeatureCollection") {
        ...
        if (featureCollection) {
          ...
          var fg = L.featureGroup(layers).bindPopup(function (_ref) {
      ...
      if (map) {
        ...
        if (visible) {
          if (link && link[name]) {
            ...
            var _layer2 = L.tileLayer.wms("".concat(serviceProxy, "?").concat(encodeURIComponent(url.toString())), {
              layers: name,
              styles: "",
              width: width,
              height: height,
...
//# sourceMappingURL=scanex-wfs-wms.umd.js.map
